...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 2", range = "B:G", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 2",
...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 2", range = "K3:K15", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 2",
...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 3", range = "A1:J30", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 3",
            data = cuadro_4,
            reformat = FALSE,
...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 4", range = "A1:G26", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 4",
            data = cuadro_5,
            reformat = FALSE,
...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 5", range = "A1:D20", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 5",
...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 6", range = "A1:E40", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 6",
...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 7", range = "A:I", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 7",
            data = cuadro_8,
            reformat = FALSE,
...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 8", range = "A:B", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 8",
            data = cuadro_8_1,
            reformat = FALSE,
...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 9", range = "A:H", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 9",
            data = cuadro_10_1,
            reformat = FALSE,
...
range_clear(resultados_a12_ggsheet, sheet = "Hoja 11", range = "A:E", reformat = FALSE)
range_write(resultados_a12_ggsheet, 
            sheet = "Hoja 11",
            data = cuadro_10_3,
            reformat = FALSE,
